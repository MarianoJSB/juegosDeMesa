        ...
        <table id="miTabla">
            ...
            <?php 
                ...
                while ($registro=mysqli_fetch_assoc($juegos)) {
                    ...
                    echo'
                    <tr>
                        <td><label>b</label><input type="text" value="'.$registro['nombre'].'" name="Nombre" id=""></td>
                        <td><label>c</label><input type="text" value="'.$registroCat['nombre'].'" name="Categoria" id=""></td>
                        <td id="a" title="555"><label>a</label><input type="text" value="'.$registroProv['nombre'].'" name="Proveedor" id=""></td>
                        <td><label>2</label><input type="number" value="'.$registro['precio'].'" name="Precio" id=""></td>
                        <td><label>3</label><input type="number" value="'.$registro['ganancia'].'" name="Ganancias" id=""></td>
                        <td><label>1</label><input type="number" value="'.$registro['stock'].'" name="Stock" id=""></td>
                        <td>         
